...
/**
 * Tests for auth_azureb2c jwt class.
 *
...
class auth_azureb2c_jwt_testcase extends \advanced_testcase {
     ...
     * @param string $encodedjwt The encoded JWT string.
     * @param mixed $expectedresult Expected decode output.
     * @param array $expectedexception Expected exception information.
     */
